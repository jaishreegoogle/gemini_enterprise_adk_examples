...
# 3. Update analyze_and_suggest_readme to use the Logic Helper
# @mcp.tool()
# def analyze_and_suggest_readme(owner: str, repo: str, path: str = "", ref: str = None) -> str:
#     # ... inside your tool logic ...
#     # INSTEAD OF: existing_content = read_file_content(owner, repo, file_path, ref=ref)
#     # USE THIS:
#     existing_content = _read_read_file_logic(owner, repo, file_path, ref=ref)
#     # ...@mcp.tool()

def find_readme_targets(owner: str, repo: str, base_path: str = "", ref: str = None) -> str:
    """Scans for subdirs missing READMEs. Use 'ref' for specific branches."""
